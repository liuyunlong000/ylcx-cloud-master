...
import com.lcxbs.sys.entity.SysCommonIconEntity;
 ...
 */
@ApiModel("图标信息")
public class SysCommonIcon extends SysCommonIconEntity{
    ...
    @Override
    @Length(max = 255,groups ={Default.class,UpdateGroup.class}, message = "图标标签长度不能超过 {max}")
    @ApiModelProperty(value = "图标标签",hidden=false,required=false,example = "")
    public String getIconLabel(){return super.getIconLabel();}
    
    @Override
    @Length(max = 255,groups ={Default.class,UpdateGroup.class}, message = "图标名称长度不能超过 {max}")
    @ApiModelProperty(value = "图标名称",hidden=false,required=false,example = "")
    public String getIconName(){return super.getIconName();}
    
    @Override
    @Length(max = 255,groups ={Default.class,UpdateGroup.class}, message = "分类长度不能超过 {max}")
    @ApiModelProperty(value = "分类",hidden=false,required=false,example = "")
    public String getSourceType(){return super.getSourceType();}
	...
	//region 构造方法
	/**无参构造函数*/
    public SysCommonIcon(){super();}
    /**带主键构造函数*/
    public SysCommonIcon(Long id){super(id);}
	//endregion
}
