...
import com.lcxbs.wz.entity.WzNewsEntity;
...
@ApiModel("新闻中心")
public class WzNews extends WzNewsEntity {
    ...
    @Override
    @Length(max = 200,groups ={Default.class,UpdateGroup.class}, message = "图片长度不能超过 {max}")
    @ApiModelProperty(value = "图片",hidden=false,required=false,example = "")
    ...
    @Override
    @Length(groups ={Default.class,UpdateGroup.class}, message = "")
    @ApiModelProperty(value = "新闻内容",hidden=false,required=false,example = "")
    ...
    public WzNews(){super();}
    /**带主键构造函数*/
    public WzNews(Long id){super(id);}
	//endregion
}
