...
import com.lcxbs.wz.entity.WzHomeEntity;
...
@ApiModel("首页轮播图")
public class WzHome extends WzHomeEntity {
    ...
    @ApiModelProperty(value = "图片url",hidden=false,required=false,example = "")
    public String getImgUrl(){return super.getImgUrl();}
    ...
    public WzHome(){super();}
    /**带主键构造函数*/
    public WzHome(Long id){super(id);}
	//endregion
}
