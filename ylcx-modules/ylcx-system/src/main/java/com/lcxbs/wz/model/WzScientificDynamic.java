...
import com.lcxbs.wz.entity.WzScientificDynamicEntity;
...
@ApiModel("科研动态")
public class WzScientificDynamic extends WzScientificDynamicEntity {
    ...
    @ApiModelProperty(value = "动态内容",hidden=false,required=false,example = "")
	...
	//region 构造方法
	/**无参构造函数*/
    public WzScientificDynamic(){super();}
    /**带主键构造函数*/
    public WzScientificDynamic(Long id){super(id);}
	//endregion
}
