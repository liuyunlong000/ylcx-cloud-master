...
import com.lcxbs.wz.entity.WzProductEntity;
...
@ApiModel("产品介绍")
public class WzProduct extends WzProductEntity {
    ...
    @ApiModelProperty(value = "产品名称",hidden=false,required=false,example = "")
	...
	//region 构造方法
	/**无参构造函数*/
    public WzProduct(){super();}
    /**带主键构造函数*/
    public WzProduct(Long id){super(id);}
	//endregion
}
