...
import com.lcxbs.wz.entity.WzScientificEntity;
...
@ApiModel("科学研究")
public class WzScientific extends WzScientificEntity {
    ...
    @ApiModelProperty(value = "研究机构名称",hidden=false,required=false,example = "")
    public String getName(){return super.getName();}

    @Override
    @Length(max = 100,groups ={Default.class,UpdateGroup.class}, message = "路由长度不能超过 {max}")
    @ApiModelProperty(value = "路由",hidden=false,required=false,example = "")
	...
	//region 构造方法
	/**无参构造函数*/
    public WzScientific(){super();}
    /**带主键构造函数*/
    public WzScientific(Long id){super(id);}
	//endregion
}
