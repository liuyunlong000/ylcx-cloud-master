...
import com.lcxbs.wz.entity.WzLeaderEntity;
...
@ApiModel("院领导")
public class WzLeader extends WzLeaderEntity {
    ...
    @ApiModelProperty(value = "姓名",hidden=false,required=false,example = "")
	...
	//region 构造方法
	/**无参构造函数*/
    public WzLeader(){super();}
    /**带主键构造函数*/
    public WzLeader(Long id){super(id);}
	//endregion
}
