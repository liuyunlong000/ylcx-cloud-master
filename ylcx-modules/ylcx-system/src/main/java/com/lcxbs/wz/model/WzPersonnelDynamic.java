...
import com.lcxbs.wz.entity.WzPersonnelDynamicEntity;
...
@ApiModel("人才动态")
public class WzPersonnelDynamic extends WzPersonnelDynamicEntity {
	...
	//region 构造方法
	/**无参构造函数*/
    public WzPersonnelDynamic(){super();}
    /**带主键构造函数*/
    public WzPersonnelDynamic(Long id){super(id);}
	//endregion
}
