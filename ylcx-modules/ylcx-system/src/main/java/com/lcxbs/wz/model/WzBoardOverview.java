...
import com.lcxbs.wz.entity.WzBoardOverviewEntity;
...
@ApiModel("板块概述")
public class WzBoardOverview extends WzBoardOverviewEntity {
	...
	//region 构造方法
	/**无参构造函数*/
    public WzBoardOverview(){super();}
    /**带主键构造函数*/
    public WzBoardOverview(Long id){super(id);}
	//endregion
}
