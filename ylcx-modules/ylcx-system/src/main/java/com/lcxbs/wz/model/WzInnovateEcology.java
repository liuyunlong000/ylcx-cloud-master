...
import com.lcxbs.wz.entity.WzInnovateEcologyEntity;
...
@ApiModel("创新生态")
public class WzInnovateEcology extends WzInnovateEcologyEntity {
	...
	//region 构造方法
	/**无参构造函数*/
    public WzInnovateEcology(){super();}
    /**带主键构造函数*/
    public WzInnovateEcology(Long id){super(id);}
	//endregion
}
