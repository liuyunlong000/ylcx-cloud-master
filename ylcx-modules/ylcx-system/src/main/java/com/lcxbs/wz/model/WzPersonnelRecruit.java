...
import com.lcxbs.wz.entity.WzPersonnelRecruitEntity;
...
@ApiModel("人才招聘")
public class WzPersonnelRecruit extends WzPersonnelRecruitEntity {
	...
	//region 构造方法
	/**无参构造函数*/
    public WzPersonnelRecruit(){super();}
    /**带主键构造函数*/
    public WzPersonnelRecruit(Long id){super(id);}
	//endregion
}
