...
import com.lcxbs.wz.entity.WzInnovatePlateFormEntity;
...
@ApiModel("创新平台")
public class WzInnovatePlateForm extends WzInnovatePlateFormEntity {
    ...
    @ApiModelProperty(value = "创新名称",hidden=false,required=false,example = "")
	...
	//region 构造方法
	/**无参构造函数*/
    public WzInnovatePlateForm(){super();}
    /**带主键构造函数*/
    public WzInnovatePlateForm(Long id){super(id);}
	//endregion
}
