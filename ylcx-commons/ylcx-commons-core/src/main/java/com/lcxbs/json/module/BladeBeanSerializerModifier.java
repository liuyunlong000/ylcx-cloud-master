...
import com.lcxbs.json.AnnotationUtil;
import com.lcxbs.json.JsonIgnoreNull;
import com.lcxbs.json.JsonNullSerializer;
import com.lcxbs.json.StringPool;
...
public class BladeBeanSerializerModifier extends BeanSerializerModifier {
    ...
    private final Logger log= LoggerFactory.getLogger(BladeBeanSerializerModifier.class);
    ...
    public List<BeanPropertyWriter> changeProperties(SerializationConfig config, BeanDescription beanDesc,
        ...
        log.info(">>>>>BladeBeanSerializerModifier start...");
        //还原
//        config.getDefaultPropertyInclusion().withValueInclusion(JsonInclude.Include.USE_DEFAULTS);
        List<BeanPropertyWriter> newBeanProperties = beanProperties;
        ...
        newBeanProperties.forEach(writer -> {
...
//            }).collect(Collectors.toList());
        ...
        return super.changeProperties(config, beanDesc, newBeanProperties);
    }
